...
- A **`.env`** with at least the loader download base (below).
...
|---|---|---|
| `DEIONIZER_LOADER_BASE_URL` | any image build | Base URL the ionCube loader is downloaded from at build time. The tool does not bundle or hardcode the vendor's loader; you supply the URL from their downloads page. |
